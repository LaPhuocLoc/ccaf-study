...
Trang ôn thi **Claude Certified Architect – Foundations (CCAR-F)** bằng tiếng Việt — kèm bản tiếng Nhật (日本語版).

👉 **Mở trang:** https://laphuocloc.github.io/ccaf-study/
👉 **日本語版:** https://laphuocloc.github.io/ccaf-study/CCA-F-Study-ja.html
...
4. **Đăng ký & thi** — hướng dẫn đăng ký 15 bước và quy chế thi.
...
[`CCA-F-Study-ja.html`](CCA-F-Study-ja.html) はこのページの日本語訳です。構成と機能はベトナム語版と同じで、問題文・選択肢・専門用語・固有名詞は英語のまま、本文と quiz の解説を日本語にしています。ヘッダーの 🌐 `Tiếng Việt | 日本語` で両方の版を切り替えられ、学習の進捗（localStorage）も共有されます。ブラウザが日本語設定の場合、トップ URL は日本語版を開き、ベトナム語版には日本語版への案内バナーが表示されます（一度選んだ言語が優先されます）。
